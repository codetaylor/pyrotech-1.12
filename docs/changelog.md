1.1.1
  ...
  * Notes:
    ...
    * Do you have duplicate iron and gold slag? Remove those entries from the `module.tech.Bloomery.Slag-Custom.json` file.
  ...
  * Changed:
    ...
    * All slag items and blocks generated by the compat system are now suffixed with `_compat` to avoid crash conflict with slag items and blocks generated by the `module.tech.Bloomery.Slag-Custom.json` file (#66)
