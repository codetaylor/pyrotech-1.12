...
public class CrucibleFluidRenderer
    implements IInteractionRenderer<TileCrucibleStone.InteractionBucket> {
  ...
  @Override
  public void renderSolidPass(TileCrucibleStone.InteractionBucket interaction, World world, RenderItem renderItem, BlockPos pos, IBlockState blockState, float partialTicks) {
  ...
  @Override
  public void renderSolidPassText(TileCrucibleStone.InteractionBucket interaction, World world, FontRenderer fontRenderer, int yaw, Vec3d offset, BlockPos pos, IBlockState blockState, float partialTicks) {
    // no-op
  }

  @Override
  public boolean renderAdditivePass(TileCrucibleStone.InteractionBucket interaction, World world, RenderItem renderItem, EnumFacing hitSide, Vec3d hitVec, BlockPos hitPos, IBlockState blockState, ItemStack heldItemMainHand, float partialTicks) {
