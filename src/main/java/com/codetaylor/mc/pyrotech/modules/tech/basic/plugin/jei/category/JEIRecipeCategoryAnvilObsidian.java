...
public class JEIRecipeCategoryAnvilObsidian
    extends PyrotechRecipeCategory<JEIRecipeWrapperAnvil> {

  public static final String UID = ModuleTechBasic.MOD_ID + ".anvil.obsidian";
  ...
  public JEIRecipeCategoryAnvilObsidian(IGuiHelper guiHelper) {
    ...
    this.title = Translator.translateToLocal("gui." + ModuleTechBasic.MOD_ID + ".jei.category.anvil.obsidian");
  }
