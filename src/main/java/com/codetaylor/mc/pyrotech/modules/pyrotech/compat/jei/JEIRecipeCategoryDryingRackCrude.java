...
public class JEIRecipeCategoryDryingRackCrude
  ...
  public JEIRecipeCategoryDryingRackCrude(IGuiHelper guiHelper) {
    ...
    this.title = Translator.translateToLocal("gui." + ModulePyrotech.MOD_ID + ".jei.category.drying.rack.crude");
  }
  ...
  @Override
  public void setRecipe(IRecipeLayout recipeLayout, JEIRecipeWrapperDryingRackCrude recipeWrapper, IIngredients ingredients) {
