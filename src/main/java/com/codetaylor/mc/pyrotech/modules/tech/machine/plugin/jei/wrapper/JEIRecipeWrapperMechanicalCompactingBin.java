...
public class JEIRecipeWrapperMechanicalCompactingBin
  ...
  public JEIRecipeWrapperMechanicalCompactingBin(MechanicalCompactingBinRecipe recipe) {
  ...
  public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
    ...
    String locationString = ArrayHelper.getOrLast(ModuleTechBasicConfig.COMPACTING_BIN.JEI_HARVEST_LEVEL_ITEM, index);
