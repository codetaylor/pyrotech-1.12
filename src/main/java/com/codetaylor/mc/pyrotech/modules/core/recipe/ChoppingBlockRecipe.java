...
public class ChoppingBlockRecipe
  ...
  public ChoppingBlockRecipe(ResourceLocation group, NonNullList<Ingredient> input, @Nonnull ItemStack result) {
  ...
  public NonNullList<ItemStack> getRemainingItems(InventoryCrafting inv) {
    ...
    for (int i = 0; i < result.size(); i++) {
      ...
      if (OreDictHelper.contains("toolAxe", itemStack)) {
  ...
  public static class Factory
    ...
    public IRecipe parse(JsonContext context, JsonObject json) {
      ...
      return new ChoppingBlockRecipe(group.isEmpty() ? null : new ResourceLocation(group), ingredients, itemstack);
    }
  }
}
