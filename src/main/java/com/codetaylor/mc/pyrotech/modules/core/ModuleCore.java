...
public class ModuleCore
  ...
  public static class Blocks {
    ...
    @GameRegistry.ObjectHolder(BlockRefractoryBrickWall.NAME)
    public static final BlockRefractoryBrickWall REFRACTORY_BRICK_WALL;
  ...
  public static class Items {
    ...
    @GameRegistry.ObjectHolder(ItemFreckleberries.NAME)
    public static final ItemFreckleberries FRECKLEBERRIES;
  ...
  public static class Fluids {
    ...
    public static final Fluid FRECKLEBERRY_WINE;
