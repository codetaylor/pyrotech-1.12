...
public class BowDrillDurableRecipe
    extends ShapedOreRecipe {

  private BowDrillDurableRecipe(ResourceLocation group, @Nonnull ItemStack result, CraftingHelper.ShapedPrimer primer) {
  ...
  public ItemStack getCraftingResult(@Nonnull InventoryCrafting inventoryCrafting) {
    ...
    result.setItemDamage(ModuleIgnitionConfig.IGNITERS.DURABLE_BOW_DRILL_DURABILITY);
    return result;
  }
  ...
  public static class Factory
    ...
    public IRecipe parse(JsonContext context, JsonObject json) {
      ...
      return new BowDrillDurableRecipe(group.isEmpty() ? null : new ResourceLocation(group), result, primer);
    }
  }
}
