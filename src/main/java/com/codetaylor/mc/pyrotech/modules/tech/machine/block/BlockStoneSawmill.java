...
public class BlockStoneSawmill
  ...
  public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag flag) {
    ...
    if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)
      ...
      int inputSlotSize = ModuleTechMachineConfig.STONE_SAWMILL.INPUT_SLOT_SIZE;
      ...
      int fuelSlotSize = ModuleTechMachineConfig.STONE_SAWMILL.FUEL_SLOT_SIZE;
      ...
      int fuelBurnTimeModifier = (int) (ModuleTechMachineConfig.STONE_SAWMILL.FUEL_BURN_TIME_MODIFIER * 100);
      ...
      if (ModuleTechMachineConfig.STONE_SAWMILL.KEEP_HEAT) {
