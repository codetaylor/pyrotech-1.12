...
@ZenDocClass("mods.pyrotech.MechanicalBellows")
@ZenDocPrepend({"docs/include/header.md"})
@ZenClass("mods.pyrotech.MechanicalBellows")
public class ZenMechanicalBellows {
  ...
  public static void setGameStages(ZenStages stages) {
    ...
    ModuleTechMachineConfig.STAGES_MECHANICAL_BELLOWS = stages.getStages();
  }
}
