...
@ZenDocClass("mods.pyrotech.ButchersBlock")
@ZenDocPrepend({"docs/include/header.md"})
@ZenClass("mods.pyrotech.ButchersBlock")
public class ZenButchersBlock {
  ...
  public static void setGameStages(ZenStages stages) {
    ...
    ModuleHuntingConfig.STAGES_BUTCHERS_BLOCK = stages.getStages();
  }
}
