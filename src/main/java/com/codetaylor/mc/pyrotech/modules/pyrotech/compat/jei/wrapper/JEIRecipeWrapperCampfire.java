...
public class JEIRecipeWrapperCampfire
  ...
  private static final String TIME_STRING = StringHelper.ticksToHMS(ModulePyrotechConfig.CAMPFIRE.COOK_TIME_TICKS);
  ...
  public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
    ...
    minecraft.fontRenderer.drawString(TIME_STRING, recipeWidth - stringWidth, 0, Color.GRAY.getRGB());
  }
}
