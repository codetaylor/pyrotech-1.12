...
public class JEIRecipeWrapperCrudeDryingRack
  ...
  public JEIRecipeWrapperCrudeDryingRack(DryingRackRecipeBase recipe) {
  ...
  protected int getRecipeTime(IRecipeTimed recipe) {
    ...
    return (int) (super.getRecipeTime(recipe) * ModuleTechBasicConfig.CRUDE_DRYING_RACK.BASE_RECIPE_DURATION_MODIFIER);
  }
}
