...
@ZenDocClass("mods.pyrotech.ObsidianAnvil")
@ZenDocPrepend({"docs/include/header.md"})
@ZenDocAppend({"docs/include/anvil_obsidian.example.md"})
@ZenClass("mods.pyrotech.ObsidianAnvil")
public class ZenAnvilObsidian {
  ...
  public static class AddRecipe
    ...
    public void apply() {
      ...
      if (this.inherited) {
        RecipeHelper.inherit("obsidian_anvil", ModuleTechBasic.Registries.ANVIL_RECIPE, AnvilIroncladRecipesAdd.INHERIT_TRANSFORMER, recipe);
      }
    }
    ...
    public String describe() {
      ...
      return "Adding obsidian anvil recipe for " + this.output + ", inherited=" + this.inherited;
    }
  }
