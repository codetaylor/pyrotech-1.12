...
@ZenDocClass("mods.pyrotech.FaucetBrick")
@ZenClass("mods.pyrotech.FaucetBrick")
public class ZenFaucetBrick {
  ...
  public static void setGameStages(ZenStages stages) {
    ...
    ModuleStorageConfig.STAGES_FAUCET_BRICK = stages.getStages();
  }
}
