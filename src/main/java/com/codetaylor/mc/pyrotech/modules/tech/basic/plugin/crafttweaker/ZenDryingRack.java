...
public class ZenDryingRack {
  ...
  public static void setBiomeSpeed(float speed, String biome) {
    ...
    ModuleTechBasicConfig.DryingRack.BIOME_MODIFIERS.put(biome, speed);
  }
  ...
  public static class AddRecipe
    ...
    public void apply() {
      ...
      if (this.inherited) {
        ...
        if (ModPyrotech.INSTANCE.isModuleEnabled(ModuleTechMachine.class)) {
          StoneOvenRecipe stoneOvenRecipe = RecipeHelper.inherit("drying_rack", ModuleTechMachine.Registries.STONE_OVEN_RECIPES, StoneOvenRecipesAdd.INHERIT_TRANSFORMER, recipe);
    ...
    public String describe() {
      ...
      return "Adding drying rack recipe for " + this.output + ", inherited=" + this.inherited;
    }
  }
