...
public class ItemQuartzAxe
    extends ItemAxeBase
    implements IQuartzTool {

  public static final String NAME = "quartz_axe";

  public ItemQuartzAxe(float damage, float speed) {

    super(ModuleCore.Materials.QUARTZ, damage, speed, "quartz");
