...
public class ShearingPeltLlamaRecipe
    extends ShapelessOreRecipe {

  public ShearingPeltLlamaRecipe(ResourceLocation group, NonNullList<Ingredient> input, @Nonnull ItemStack result) {
  ...
  public NonNullList<ItemStack> getRemainingItems(InventoryCrafting inv) {
    ...
    for (int i = 0; i < result.size(); i++) {
      ...
      if (OreDictHelper.contains("toolShears", itemStack)) {
        ...
        result.set(i, new ItemStack(ModuleHunting.Items.HIDE_LLAMA));
  ...
  public static class Factory
    ...
    public IRecipe parse(JsonContext context, JsonObject json) {
      ...
      return new ShearingPeltLlamaRecipe(group.isEmpty() ? null : new ResourceLocation(group), ingredients, itemstack);
    }
  }
}
