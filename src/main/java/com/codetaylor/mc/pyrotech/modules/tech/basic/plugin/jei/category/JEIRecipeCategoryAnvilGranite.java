...
public class JEIRecipeCategoryAnvilGranite
    extends PyrotechRecipeCategory<JEIRecipeWrapperAnvil> {

  public static final String UID = ModuleTechBasic.MOD_ID + ".anvil.granite";
  ...
  public JEIRecipeCategoryAnvilGranite(IGuiHelper guiHelper) {
    ...
    this.title = Translator.translateToLocal("gui." + ModuleTechBasic.MOD_ID + ".jei.category.anvil.granite");
  }
