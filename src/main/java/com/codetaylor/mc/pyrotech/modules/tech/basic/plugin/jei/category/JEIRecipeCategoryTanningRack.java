...
public class JEIRecipeCategoryTanningRack
    extends PyrotechRecipeCategory<JEIRecipeWrapperTanningRack> {

  public static final String UID = ModuleTechBasic.MOD_ID + ".tanning";
  ...
  public JEIRecipeCategoryTanningRack(IGuiHelper guiHelper) {
    ...
    this.title = Translator.translateToLocal("gui." + ModuleTechBasic.MOD_ID + ".jei.category.tanning.rack");
  }
  ...
  @Override
  public void setRecipe(IRecipeLayout recipeLayout, JEIRecipeWrapperTanningRack recipeWrapper, IIngredients ingredients) {
