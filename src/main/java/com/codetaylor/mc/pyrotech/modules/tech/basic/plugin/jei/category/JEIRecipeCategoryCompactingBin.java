...
public class JEIRecipeCategoryCompactingBin
    extends PyrotechRecipeCategory<JEIRecipeWrapperCompactingBin> {

  public static final String UID = ModuleTechBasic.MOD_ID + ".compacting.bin";
  ...
  public JEIRecipeCategoryCompactingBin(IGuiHelper guiHelper) {
    ...
    this.title = Translator.translateToLocal("gui." + ModuleTechBasic.MOD_ID + ".jei.category.compacting.bin");
  }
