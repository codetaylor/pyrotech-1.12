...
public class JEIRecipeCategoryMechanicalCompactingBin
  ...
  public JEIRecipeCategoryMechanicalCompactingBin(IGuiHelper guiHelper) {
    ...
    this.title = Translator.translateToLocal("gui." + ModuleTechBasic.MOD_ID + ".jei.category.mechanical.compacting.bin");
  }
